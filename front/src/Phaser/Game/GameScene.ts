...
import {RoomCreatedInterface, SeeMePeer} from "../../WebRtc/SeeMePeer";
        ...
        this.gameMap.onPropertyChange(type, async (newValue, oldValue, allProps) => {
            ...
            if (newValue === undefined) {
                ...
                openWebsiteFunction = async () => {
                    ...
                    coWebsiteManager.loadCoWebsite(url, this.MapUrlFile, allProps.get('openWebsiteAllowApi') as boolean | undefined, "camera; microphone; autoplay; fullscreen; picture-in-picture;", false);
...
// >>>>>>> upstream/develop
    ...
    private doUpdatePlayerPosition(message: MessageUserMovedInterface): void {
        ...
        const playerMovement = new PlayerMovement({
            x: player.x,
            y: player.y
        }, this.currentTick, message.position, this.currentTick + POSITION_DELAY);
