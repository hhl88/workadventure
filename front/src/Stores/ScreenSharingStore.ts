...
import {seeMeStore} from "./SeeMeStore";

import {gameOverlayVisibilityStore, LocalStreamStoreValue,} from "./MediaStore";
 ...
 */
export const screenSharingAvailableStore = derived([peerStore, seeMeStore], ([$peerStore, $seemeStore], set) => {
