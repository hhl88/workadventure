...
export class UserJoinedMeetingRoomMessage extends jspb.Message { 
    getJoined(): boolean;
    setJoined(value: boolean): UserJoinedMeetingRoomMessage;


    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): UserJoinedMeetingRoomMessage.AsObject;
    static toObject(includeInstance: boolean, msg: UserJoinedMeetingRoomMessage): UserJoinedMeetingRoomMessage.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: UserJoinedMeetingRoomMessage, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): UserJoinedMeetingRoomMessage;
    static deserializeBinaryFromReader(message: UserJoinedMeetingRoomMessage, reader: jspb.BinaryReader): UserJoinedMeetingRoomMessage;
}

export namespace UserJoinedMeetingRoomMessage {
    export type AsObject = {
        joined: boolean,
    }
}

export class UserJoinedGroupMessage extends jspb.Message { 
    getUserid(): number;
    setUserid(value: number): UserJoinedGroupMessage;

    getGroupid(): number;
    setGroupid(value: number): UserJoinedGroupMessage;

    getJoined(): boolean;
    setJoined(value: boolean): UserJoinedGroupMessage;


    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): UserJoinedGroupMessage.AsObject;
    static toObject(includeInstance: boolean, msg: UserJoinedGroupMessage): UserJoinedGroupMessage.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: UserJoinedGroupMessage, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): UserJoinedGroupMessage;
    static deserializeBinaryFromReader(message: UserJoinedGroupMessage, reader: jspb.BinaryReader): UserJoinedGroupMessage;
}

export namespace UserJoinedGroupMessage {
    export type AsObject = {
        userid: number,
        groupid: number,
        joined: boolean,
...
export class ReportPlayerMessage extends jspb.Message { 
    ...
    setReporteduserid(value: number): ReportPlayerMessage;
...
export class ClientToServerMessage extends jspb.Message { 
    ...
    hasUserjoinedmeetingroommessage(): boolean;
    clearUserjoinedmeetingroommessage(): void;
    getUserjoinedmeetingroommessage(): UserJoinedMeetingRoomMessage | undefined;
    setUserjoinedmeetingroommessage(value?: UserJoinedMeetingRoomMessage): ClientToServerMessage;
...
export namespace ClientToServerMessage {
    export type AsObject = {
        ...
        userjoinedmeetingroommessage?: UserJoinedMeetingRoomMessage.AsObject,
    ...
    USERJOINEDMEETINGROOMMESSAGE = 13,
...
export class SubMessage extends jspb.Message { 
    ...
    clearUserjoinedmeetingroommessage(): void;
    getUserjoinedmeetingroommessage(): UserJoinedMeetingRoomMessage | undefined;
    setUserjoinedmeetingroommessage(value?: UserJoinedMeetingRoomMessage): SubMessage;


    hasUserjoinedgroupmessage(): boolean;
    clearUserjoinedgroupmessage(): void;
    getUserjoinedgroupmessage(): UserJoinedGroupMessage | undefined;
    setUserjoinedgroupmessage(value?: UserJoinedGroupMessage): SubMessage;
...
export namespace SubMessage {
    export type AsObject = {
        ...
        itemeventmessage?: ItemEventMessage.AsObject,
        userjoinedmeetingroommessage?: UserJoinedMeetingRoomMessage.AsObject,
        userjoinedgroupmessage?: UserJoinedGroupMessage.AsObject,
    ...
    USERJOINEDMEETINGROOMMESSAGE = 7,

    USERJOINEDGROUPMESSAGE = 8,
...
export class WebRtcStartMessage extends jspb.Message { 
    ...
    getName(): string;
    setName(value: string): WebRtcStartMessage;
    ...
    getRoomid(): number;
    setRoomid(value: number): WebRtcStartMessage;
...
export class PusherToBackMessage extends jspb.Message { 
    ...
    clearUserjoinedmeetingroommessage(): void;
    getUserjoinedmeetingroommessage(): UserJoinedMeetingRoomMessage | undefined;
    setUserjoinedmeetingroommessage(value?: UserJoinedMeetingRoomMessage): PusherToBackMessage;
...
export namespace PusherToBackMessage {
    ...
    USERJOINEDMEETINGROOMMESSAGE = 14,

    EMOTEPROMPTMESSAGE = 15,
